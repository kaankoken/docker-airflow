...
* Based on Python (3.10-slim-buster) official Image [python:3.10-slim-buster](https://hub.docker.com/_/python/) and uses the official [Postgres](https://hub.docker.com/_/postgres/) as backend and [Redis](https://hub.docker.com/_/redis/) as queue
...
You can also use this to run a bash shell or any other command in the same environment that airflow would be run in:
    ...
    docker run --rm -ti serraview/docker-airflow:2.4.3 bash
    docker run --rm -ti serraview/docker-airflow:2.4.3 ipython
